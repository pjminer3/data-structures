describe('doublyLinkedList', function() {
  ...
  it('should have a head, tail, and previous property', function() {
  ...
  it('should designate a new head when new nodes are added', function() {
    doublyLinkedList.addToHead(4); // should work when adding the initial node ()
    expect(doublyLinkedList.tail.value).to.equal(4);
  ...
  it('should return value of head node when using \"peek\"', function() {
    ...
    doublyLinkedList.addToTail(4);
    expect(doublyLinkedList.peek()).to.equal(3);
  });

  it('should add a "previous" property to each node that points to the node before it', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
